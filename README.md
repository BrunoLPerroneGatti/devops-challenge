...
Application logs are collected from Docker containers using Grafana Alloy and sent to Loki. These logs can then be queried and explored through Grafana.
...
The observability stack is deployed using Docker Compose alongside the application.